---
title: "Analyzing Regional Trends in Influenza-Like Illness (ILI) in Kenya (2023–2024): A Quantitative Epidemiology Case Study"
...
```{r load-data}
data <- read.csv("data/Epi_Task_Data.csv", stringsAsFactors=TRUE)
head(data)
view(data)
```
